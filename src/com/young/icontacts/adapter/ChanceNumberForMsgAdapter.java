...
public class ChanceNumberForMsgAdapter extends MyAdapter{
	...
	public ChanceNumberForMsgAdapter (Context context,List<NumAndTypeInfo> list,DatabaseDAO dao){
	...
	public View getView(int pos, View convertView, ViewGroup parentView) {
		...
		if (convertView == null) {
				convertView = mInflater.inflate(
						R.layout.chance_number_formsg_item_layout, null);

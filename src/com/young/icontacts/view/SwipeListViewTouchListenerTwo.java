 ...
 */
public class SwipeListViewTouchListenerTwo implements View.OnTouchListener {
     ...
     */
    public SwipeListViewTouchListenerTwo(SwipeListView swipeListView, int swipeFrontView, int swipeBackView) {
    ...
    /**
     * @see View.OnTouchListener#(android.view.View, android.view.MotionEvent)
     */
